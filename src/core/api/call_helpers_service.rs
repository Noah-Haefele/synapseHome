...
pub struct CallHelpersService {
    call_handler: Arc<Mutex<CallHandler>>,
    device_manager: Arc<Mutex<DeviceManager>>,
}

impl CallHelpersService {
    pub fn new(
        call_handler: Arc<Mutex<CallHandler>>,
        device_manager: Arc<Mutex<DeviceManager>>,
    ) -> Self {
...
#[tonic::async_trait]
impl CallHelpers for CallHelpersService {
    async fn get_call_label(&self, _: Request<()>) -> Result<Response<GetCallLabelReply>, Status> {
        let call_device_id = {
            ...
            call_handler.get_call_device_id()
        };
        ...
        let device_name = {
            ...
            device_manager.get_device_name(call_device_id)
        };
        ...
        let call_label = {
            ...
            call_handler.get_call_label(&device_name)
        };
